...
const Card: React.FC<CardProps> = ({ data }) => {
  ...
  return (
    <div className=" w-full h-[250px] sm:h-[320px] flex flex-col shadow-lg rounded-xl overflow-hidden bg-[#0a1435] max-w-sm md:max-w-md lg:max-w-lg mx-auto transition-transform transform hover:scale-105 duration-300">
      <img
